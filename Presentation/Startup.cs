...
namespace CleanArchitecture. Presentation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IGetProductDetailsQuery, GetProductDetailsQuery>();
            services.AddScoped<IGetProductListQuery, GetProductListQuery>();
            services.AddScoped<IUserProductsFactory, UserProductsFactory>();
            services.AddScoped<IUserProductsRepositoryFacade, UserProductsRepositoryFacade>();
